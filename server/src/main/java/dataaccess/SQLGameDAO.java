...
public class SQLGameDAO implements GameDAO{
    ...
    public int createGame(GameData g) throws DataAccessException {
        ...
        return DatabaseManager.executeUpdate(statement, gameName, game);
    }
    ...
    public void updateGame(GameData g) throws DataAccessException {
        var statement = """
                ...
                WHERE id = ?
                """;
        DatabaseManager.executeUpdate(statement, g.whiteUsername(), g.blackUsername(), new Gson().toJson(g.game()), g.gameID());
    }
